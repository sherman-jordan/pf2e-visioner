    ...
    async applyVisibilityChange() {
      ...
      for (const sourceToken of sourceTokens) {
        for (const targetToken of targetTokens) {
          ...
          console.log(`PF2E Visioner | Applying visibility change: ${observerToken.name} sees ${subjectToken.name} as ${newVisibility}`);
          console.log(`PF2E Visioner | Direction: ${this.direction}, Effect will be placed on: subject (primary token)`);
          ...
          if (this.mode === "remove") {
            ...
            console.log(`PF2E Visioner | Remove mode: Removing all visibility effects`);
          }
          ...
          console.log(`PF2E Visioner | Applied visibility change: ${observerToken.name} sees ${subjectToken.name} as ${newVisibility}`);
          console.log(`PF2E Visioner | Effect placed on: subject (${subjectToken.name})`);
        }
      }
    }
    ...
    getDirectionalTokens() {
      ...
      switch (this.observers) {
        ...
        case "targeted":
          ...
          console.log(`PF2E Visioner | Using targeted tokens as observers: ${observerTokens.map(t => t.name).join(', ')}`);
          break;
      }
      ...
      if (this.direction === "from") {
        ...
        // Log for clarity
        console.log(`PF2E Visioner | FROM direction: Observers (${observerTokens.map(t => t.name).join(', ')}) will see subject (${primaryToken.name}) as ${this.status}`);
      } else {
        ...
        // Log for clarity
        console.log(`PF2E Visioner | TO direction: Subject (${primaryToken.name}) will see observers (${observerTokens.map(t => t.name).join(', ')}) as ${this.status}`);
      }
    ...
    calculateNewVisibility(currentVisibility) {
      ...
      switch (this.mode) {
        ...
        case "remove":
          ...
          console.log(`PF2E Visioner | Remove mode: Resetting visibility to observed`);
          return "observed";
    ...
    async resetVisibility() {
      ...
      for (const sourceToken of sourceTokens) {
        for (const targetToken of targetTokens) {
          ...
          console.log(`PF2E Visioner | Resetting visibility: ${observerToken.name} now sees ${subjectToken.name} as observed`);
          console.log(`PF2E Visioner | Direction: ${this.direction}, Removing effect from: subject (primary token)`);
          ...
          console.log(`PF2E Visioner | Reset visibility: ${observerToken.name} now sees ${subjectToken.name} as observed`);
          console.log(`PF2E Visioner | Effect removed from: subject (${subjectToken.name})`);
        }
      }
    }
