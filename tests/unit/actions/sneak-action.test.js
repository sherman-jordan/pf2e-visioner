...
describe('Sneak Action Comprehensive Tests', () => {
  ...
  describe('Apply Changes (Chat Button) Tests', () => {
    describe('Ignore Allies: OFF', () => {
      ...
      test('applies changes to all tokens including allies', () => {
        const mockOutcomes = [
          { token: { id: 'ally1', actor: { alliance: 'party' } }, newVisibility: 'undetected', hasActionableChange: true },
  ...
  describe('hasActionableChange Calculation Tests', () => {
    ...
    test('hasActionableChange correctly identifies state transitions', () => {
      ...
      const testCases = [
        { oldState: 'observed', outcome: 'success', expectedNewState: 'undetected', shouldBeActionable: true },
        { oldState: 'observed', outcome: 'critical-failure', expectedNewState: 'observed', shouldBeActionable: false },
        { oldState: 'hidden', outcome: 'success', expectedNewState: 'undetected', shouldBeActionable: true },
