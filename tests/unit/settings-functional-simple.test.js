...
describe('Simple Settings Functional Tests', () => {
  ...
  describe('ignoreAllies Setting Integration', () => {
    test('is used as fallback in Sneak action filtering logic', async () => {
      ...
      const shouldFilterAllyTrue = shouldFilterAlly(mockActorToken, mockAllyToken, "enemies", ignoreAlliesSetting);
      const shouldFilterEnemyTrue = shouldFilterAlly(mockActorToken, mockEnemyToken, "enemies", ignoreAlliesSetting);
      ...
      const shouldFilterAllyFalse = shouldFilterAlly(mockActorToken, mockAllyToken, "enemies", ignoreAlliesSettingFalse);
      const shouldFilterEnemyFalse = shouldFilterAlly(mockActorToken, mockEnemyToken, "enemies", ignoreAlliesSettingFalse);
  ...
  describe('seekUseTemplate Setting Integration', () => {
    test('is used in event-binder Seek behavior', () => {
      ...
      const useTemplateTrue = game.user.isGM && game.settings.get("pf2e-visioner", "seekUseTemplate");
      expect(useTemplateTrue).toBe(true);
      
      // Test with seekUseTemplate = false
      game.settings.set('pf2e-visioner', 'seekUseTemplate', false);
      const useTemplateFalse = game.user.isGM && game.settings.get("pf2e-visioner", "seekUseTemplate");
  ...
  describe('Seek & Range Settings Integration', () => {
    ...
    test('limitSeekRangeOutOfCombat affects out-of-combat Seek range behavior', () => {
      ...
      const outOfCombatRangeLimited = game.settings.get("pf2e-visioner", "limitSeekRangeOutOfCombat");
      ...
      const outOfCombatRangeUnlimited = game.settings.get("pf2e-visioner", "limitSeekRangeOutOfCombat");
    ...
    test('seek range settings integrate with other module systems', () => {
      ...
      const mockSeekPanel = {
        ...
        rangeLimit: mockTokenVisibility.isRangeLimited ? mockTokenVisibility.seekRange : 'unlimited'
      };
  ...
  describe('Visibility & Hover Settings Integration', () => {
    ...
    test('blockTargetTooltipsForPlayers affects target mode tooltip behavior', () => {
      ...
      const blockTargetTooltips = game.settings.get("pf2e-visioner", "blockTargetTooltipsForPlayers");
      ...
      const allowTargetTooltips = game.settings.get("pf2e-visioner", "blockTargetTooltipsForPlayers");
  ...
  describe('Interface Settings Integration', () => {
    ...
    test('keybindingOpensTMInTargetMode affects keybinding behavior', () => {
      ...
      const opensInObserverMode = game.settings.get("pf2e-visioner", "keybindingOpensTMInTargetMode");
